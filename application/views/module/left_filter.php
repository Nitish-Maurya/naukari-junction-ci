					...
					<div class="jp_job_box">
                        <div class="job_detail">
                            ...
                            <span><?= $res->application ?> Applied</span>
                            <ul>
                                <li title="<?= $controller->set_language('h_work_exp'); ?>"><span><img src="<?= base_url('assets/images/experience.svg'); ?>" alt=""></span> <?= $res->exp; ?></li>
                                <li title="<?= $controller->set_language('h_job_location'); ?>"><span><img src="<?= base_url('assets/images/location.svg'); ?>" alt=""></span> <?= $res->job_location; ?></li>
                            </ul>
                        ...
                        <div class="jp_view_btn">
                            <a href="<?= base_url('home/user_jobsingle/'.$res->id.'/'.$sp2.'-'.'jobs-in-'.$string.'-'.$location2); ?>" class="jp_btn jp_btn_block"><?= $controller->set_language('view_btn'); ?></a><br><br>.
                        </div>
						<?php						
							$check_status=$this->Common_model->job_applay_status_check('jp_applay_job',$res->id,$this->email,'job_id','s_email');   //Job Applay Status Check
							if($check_status>0)
							{
								?>
								<div class="jp_view_btn">
					...
					else
					{
						...
						<div class="jp_no_doctor">
							...
							<p><?= $controller->set_language('filter_error'); ?></p>
						</div>
                    <!-- no job found end -->
						</div>
						<?php
