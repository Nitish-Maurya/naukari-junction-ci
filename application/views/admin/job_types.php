...
<div class="row" onload="job_types_fetch()">
    ...
    <input type="text" name="name" id="name2" value="<?= $data->name; ?>" class="form-control" placeholder="Update job_types Name"></form><br>
	<button id="job_type_update" class="btn">Update job_types</button><br><br>
	<?= form_close(); ?>
	</div>
	<?php } ?>
        <div class="hs_heading medium">
            <h3>All Job Types (<?= $this->Common_model->row_count('job_types'); ?>)  <a href="#add_jobtype_popup" class="btn" data-toggle="modal">Add new</a></h3>
        </div>
        ...
        <tbody>
                    ...
                    if(isset($row))
                    {
                     ...
                     <tr>
                       ...
                       <td width="200">
							<a  class="btn" title="Edit" data-name="Dentist" onclick="update_job_type('<?= $r1->id; ?>','<?= $r1->name; ?>')"><i class="fa fa-pencil" aria-hidden="true"></i></a>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="hs_input">
                    ...
                    <form id="f1"><input type="text" name="name" id="name1" class="form-control" placeholder="Add job type "></form>
                </div>
