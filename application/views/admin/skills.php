...
<div class="row" onload="job_types_fetch()">
	...
	<div id="update">
	<? form_open('admin/html/update_data/skills'); ?>
	<label>Update Job Types </label>
	<form id="f2"><input type="hidden" name="id" value="<?= $data->id; ?>">
	<input type="hidden" name="tbl_name" value="skills">
	...
	<?php } ?>
        <div class="hs_heading medium">
            <h3>All Skills (<?= $this->Common_model->row_count('skills'); ?>)  <a href="#add_jobtype_popup" class="btn" data-toggle="modal">Add new</a></h3>
        </div>
        ...
        <tbody>
                    ...
                    if(isset($row))
                    {
                     ...
                     <tr>
						...
						<td>
							<select id="jtype<?= $r1->id; ?>" onchange="skills_status(<?=  $r1->id; ?>)">
                       ...
                       <td width="200">
							<a  class="btn" title="Edit" data-name="Dentist" onclick="update_skills('<?= $r1->id; ?>','<?= $r1->name; ?>')"><i class="fa fa-pencil" aria-hidden="true"></i></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="hs_input">
                    <label>skills</label>
                    <form id="f1"><input type="text" name="name" id="name1" class="form-control" placeholder="Add skills "></form>
                </div>
				<button id="add_skills" class="btn">Add</button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<button id="skills_update" class="btn">Update</button>
			</div>
		</div>
	</div>
</div>
