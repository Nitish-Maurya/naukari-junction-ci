		...
		<div class="row">
			<div class="col-lg-10 col-md-10 col-lg-offset-1 col-md-offset-1 col-sm-offset-0 col-xs-offset-0 col-sm-12 col-xs-12">
				<div class="jp_footer_detail text-center">
					...
					?>
					<div class="jp_logo">
						<a href="<?= base_url().'recruiter'; ?>"><img src="<?= $img2; ?>" alt=""></a>
					</div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="jp_copyright_content">
					...
					<ul>
						<li><a  href="<?= base_url('recruiter/terms'); ?>"><?= $controller->set_language('trem_keyword') ?></a></li>
						<li><a  href="<?= base_url('recruiter/policy'); ?>"><?php  echo $controller->set_language('ptivcy_keyword'); ?></a></li>
						<li><a  href="<?= base_url('recruiter/about'); ?>"><?php  echo $controller->set_language('about_keyword'); ?></a></li>
						<li><a  href="<?= base_url('recruiter/contact'); ?>"><?php  echo $controller->set_language('contect_keyword'); ?></a></li> 
					</ul>
				</div>
			</div>
		</div>
