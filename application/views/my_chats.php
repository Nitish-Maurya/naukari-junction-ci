        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="jp_page_title">
                    <h3><?= $controller->set_language('chat_text'); ?></h3>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="jp_job_box applied_user">
                            ...
                            <div class="jp_view_btn">
                                <div class="jp_openChatBtnWrapper" data-uid="<?= $chat_uid[1]; ?>">
                                    ...
                                    <a class="jp_btn jp_open_chat_box" data-rid="<?= $chat_uid[1]; ?>" data-sid="<?= $_SESSION['user_id']; ?>"><?= $controller->set_language('rchat_btn_text'); ?></a> 
                                </div>
                            </div>
                        </div>
                    </div>
