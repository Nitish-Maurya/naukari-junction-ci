					...
					<div class="jp_job_box applied_user">
                        ...
                        <div class="jp_view_btn">
                            ...
                            <?php if(isset($_SESSION['chat_system']) && $_SESSION['chat_system'] == 'true'){?>
                                <div class="jp_openChatBtnWrapper" data-uid="<?= $si->id; ?>">
                                    <span class="jp_chat_count"></span>
                                    <a class="jp_btn jp_open_chat_box" data-rid="<?= $si->id; ?>" data-sid="<?= $_SESSION['user_id']; ?>"><?= $controller->set_language('rchat_btn_text'); ?></a> 
                                </div>
                            <?php } ?>
                        </div>
                    </div>
